...
md`# Flip flop without clock enable


[3.2 記憶素子を使った回路](https://openit.kek.jp/training/2012/FPGA-Training/docs/web_intro_verilog-hdl/3-2.html)のD-type Flip Flop (DFF)回路の実装です。
...
await FileAttachment("d_flip_flop.digitaljs.json").json()
)}
...
export default function define(runtime, observer) {
  ...
  const fileAttachments = new Map([
    ["d_flip_flop.digitaljs.json", {url: new URL("./files/87fadc801fe2bb2f93c67c2a1575101ae9f96cef9318bd496d8ef0241da542673204ed3399e63eeddbf6cc8480dc231f0cf923f98e1d7df56a9664320fefc0e6.json", import.meta.url), mimeType: "application/json", toString}]
  ]);
